...
def main(args):
    ...
    for data in tqdm(dataset):
        try:
            ...
            new_data = {**data}
            new_answer = {"id": data["id"], "answer": answer}
            ...
            raise Exception(f"Error at {data['id']}")
    ...
    # Store new answer
    with open(args.output_answer_path, "w") as f:
        json.dump(new_answer, f, indent=4, default=str)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_file_path", type=str, default="../dataset/mimic_iv_cxr/test_data.json")
    parser.add_argument("--db_file_path", type=str, default="../database/mimic_iv_cxr/test/mimic_iv_cxr.db")
    parser.add_argument("--output_path", type=str, default="../dataset/mimic_iv_cxr/test_data.json")
    parser.add_argument("--output_answer_path", type=str, default="../dataset/mimic_iv_cxr/test_answer.json")
